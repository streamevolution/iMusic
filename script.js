...
const fullMusicData = {
    ...
    "Cumbia": [
        { name: "Raymix", verified: true, imgSrc: "raymix.jpg", songs: [
            ...
            { title: "Gritaria", artist: "Raymix ", duration: "3:27", audioSrc: "Raymix - Gritaría (Remix).mp3", imgSrc: "c-raymix1.jpg", genre: "Cumbias" },
            { title: "La Cumbia Fresa", artist: "Raymix ", duration: "3:08", audioSrc: "Raymix - La Cumbia Fresa.mp3", imgSrc: "c-raymix2.jpg", genre: "Cumbia" },
            { title: "El Circulo", artist: "Raymix ", duration: "3:09", audioSrc: "Raymix - El Círculo.mp3", imgSrc: "c-raymix3.jpg", genre: "Cumbia" },
            { title: "Llamame", artist: "Raymix ", duration: "3:22", audioSrc: "Raymix - Llámame.mp3", imgSrc: "c-raymix4.jpg", genre: "Cumbia" },
            { title: "Mi Otra Mitad", artist: "Raymix ", duration: "4:012", audioSrc: "Raymix - Mi Otra Mitad.mp3", imgSrc: "c-raymix5.jpg", genre: "Cumbia" },
            { title: "Mírame (Remix)", artist: "Raymix, Super Lamas ", duration: "2:57", audioSrc: "Raymix - Mírame (Remix).mp3", imgSrc: "c-raymix1.jpg", genre: "Cumbia" },
            { title: "Sonidero Style", artist: "Raymix ", duration: "3:02", audioSrc: "Raymix - Sonidero Style.mp3", imgSrc: "c-raymix2.jpg", genre: "Cumbia" },
            { title: "Super Star", artist: "Raymix ", duration: "3:35", audioSrc: "Raymix - Superstar.mp3", imgSrc: "c-raymix3.jpg", genre: "Cumbia" },
            { title: "Nada", artist: "Raymix ", duration: "3:40", audioSrc: "Raymix - Nada.mp3", imgSrc: "c-raymix4.jpg", genre: "Cumbia" },
            { title: "No Hay Vida Sin Ti", artist: "Raymix ", duration: "4:07", audioSrc: "Raymix - No Hay Vida Sin Ti.mp3", imgSrc: "c-raymix5.jpg", genre: "Cumbia" },
            { title: "No Pienso Caer", artist: "Raymix ", duration: "3:51", audioSrc: "Raymix - No Pienso Caer.mp3", imgSrc: "c-raymix1.jpg", genre: "Cumbia" },
            { title: "Te Fuiste ", artist: "Raymix ", duration: "3:38", audioSrc: "Raymix - Te Fuiste.mp3", imgSrc: "c-raymix2.jpg", genre: "Cumbia" },
            { title: "Paloma Ajena (Remix)", artist: "Raymix ", duration: "3:55", audioSrc: "Raymix - Paloma Ajena (Remix).mp3", imgSrc: "c-raymix3.jpg", genre: "Cumbia" },
            { title: "¿Dónde Estarás? (Remix)", artist: "Raymix, Alcalde La Sonora ", duration: "2:36", audioSrc: "Raymix Alcalde La Sonora - ¿Dónde Estás (Remix).mp3", imgSrc: "c-raymix4.jpg", genre: "Cumbia" },
            { title: "Corazón Enamorado", artist: "Raymix, Alberto Pedraza ", duration: "4:59", audioSrc: "Raymix ft Alberto Pedraza - Corazón Enamorado.mp3", imgSrc: "c-raymix1.jpg", genre: "Cumbias" },
            { title: "Vienes Y Te Vaz", artist: "Raymix, Los Askis ", duration: "3:41", audioSrc: "Raymix Los Askis - Vienes Y Te Vas (Remix).mp3", imgSrc: "c-raymix2.jpg", genre: "Cumbia" },
            { title: "Tu Y Yo", artist: "Raymix, Paulina Rubio ", duration: "3:05", audioSrc: "Raymix Paulina Rubio - Tú Y Yo.mp3", imgSrc: "c-raymix3.jpg", genre: "Cumbia" },
            { title: "Desvelo", artist: "Raymix ", duration: "3:33", audioSrc: "Raymix-C-Kan  - Desvelo.mp3", imgSrc: "c-raymix4.jpg", genre: "Cumbia" },
            { title: "Masoquista", artist: "Raymix, Juan Solo ", duration: "3:32", audioSrc: "Raymix-Juan Solo - Masoquista.mp3", imgSrc: "c-raymix5.jpg", genre: "Cumbia" },
            { title: "Cruda", artist: "Raymix, María León ", duration: "3:13", audioSrc: "Raymix-María León  - Cruda.mp3", imgSrc: "c-raymix1.jpg", genre: "Cumbia" },
            { title: "Traviesa", artist: "Raymix, Horacio Palencia, Aczino ", duration: "2:39", audioSrc: "Raymix Horacio Palencia Aczino - Traviesa.mp3", imgSrc: "c-raymix2.jpg", genre: "Cumbia" },
            { title: "Olvídame Tu", artist: "Raymix, ICC ", duration: "4:03", audioSrc: "Raymix ICC - Olvídame Tú.mp3", imgSrc: "c-raymix3.jpg", genre: "Cumbia" },
            { title: "Ni Tu Te La Crees", artist: "Raymix, Los Socios Del Ritmo ", duration: "2:58", audioSrc: "Raymix-Los Socios Del Ritmo  - Ni Tú Te La Crees.mp3", imgSrc: "c-raymix4.jpg", genre: "Cumbia" },
            { title: "Amor Toxico", artist: "Raymix, Grupo K-L ", duration: "3:38", audioSrc: "Raymix Grupo K-L - Amor Tóxico.mp3", imgSrc: "c-raymix5.jpg", genre: "Cumbia" },
            { title: "Prisionero (De La Cumbia)", artist: "Raymix, Gepe ", duration: "3:48", audioSrc: "Raymix-Gepe  - Prisionero (De La Cumbia).mp3", imgSrc: "c-raymix1.jpg", genre: "Cumbia" },
            { title: "Alejate De Mí (Remix) ", artist: "Raymix, Mexikolombia ", duration: "2:52", audioSrc: "Raymix Mexikolombia - Aléjate De Mí (Remix).mp3", imgSrc: "c-raymix2.jpg", genre: "Cumbia" },
            { title: "Te Voy A Conquistar", artist: "Raymix ", duration: "3:44", audioSrc: "Raymix NZO - Te Voy A Conquistar.mp3", imgSrc: "c-raymix3.jpg", genre: "Cumbia" },
            { title: "Para Levantarme Del Suelo ", artist: "Raymix, Patricia Manterola ", duration: "3:17", audioSrc: "RAYMIX-PATRICIA MANTEROLA  - PARA LEVANTARME DEL SUELO.mp3", imgSrc: "c-raymix4.jpg", genre: "Cumbia" },
            { title: "Si Amas Algo Déjalo Ir", artist: "Raymix, Oliver Contreras desde la cuna de la nación ", duration: "4:27", audioSrc: "Raymix Oliver contreras desde la cuna de la nacion - Si Amas Algo Déjalo Ir.mp3", imgSrc: "c-raymix5.jpg", genre: "Cumbia" }
        ]},
...
// ⬇️ NUEVO: Definición de Temas (CON ROJO Y TURQUESA) ⬇️
const THEME_COLORS = {
    "Original": {
    ...
    "Rojo": {
        "--spotify-black": "#191414",
        "--spotify-green": "#E53935", // Rojo brillante (Material Design)
        "--spotify-gray": "#282828",
        "--spotify-light-gray": "#B3B3B3",
        "--whatsapp-green": "#25D366"
    },
    "Turquesa": {
        "--spotify-black": "#191414",
        "--spotify-green": "#00ACC1", // Turquesa (similar a cyan/aqua)
        "--spotify-gray": "#282828",
        "--spotify-light-gray": "#B3B3B3",
        "--whatsapp-green": "#25D366"
    }
...
const sidebarDownloadAppBtn = document.getElementById('sidebarDownloadAppBtn'); // ⬅️ DEFINICIÓN DEL NUEVO BOTÓN
    ...
    const createDetailRow = (key, value) => `
        <div style="display: flex; justify-content: space-between; align-items: center; padding: 10px; border-bottom: 1px solid #383838;">
            <div style="display: flex; flex-direction: column; text-align: left; flex-grow: 1;">
                <span style="font-size: 14px; color: var(--spotify-light-gray);">Cita:</span>
...
function renderArtistFullView(genre, artistName) {
    ...
    // ⬇️ NUEVA LÓGICA: Identificar la canción actualmente en reproducción para el visualizador ⬇️
    const currentSongInPlayer = currentPlaylist[currentSongIndex];
    ...
    artist.songs.forEach((song, index) => {
        ...
        // ⬇️ LÓGICA DEL VISUALIZADOR (MODIFICADO) ⬇️
        // Corregir la verificación del artista, ya que puede ser un objeto de artista O un string
        const artistMatch = song.artist 
            ? song.artist.trim() === artistName.trim()
            : currentSongInPlayer && currentSongInPlayer.artist.trim() === artistName.trim(); 
            
        const isCurrentlyPlaying = currentSongInPlayer && 
                                   currentSongInPlayer.title === song.title && 
                                   artistMatch;
                                   
        // Si está sonando y está pausado, usamos un icono de pausa. Si está sonando y reproduciendo, usamos el visualizador animado.
        const isPaused = audioPlayer.paused;
        let playingIndicator = '';

        if (isCurrentlyPlaying) {
             if (isPaused) {
                 playingIndicator = '<i class="fas fa-pause playing-indicator-icon"></i>'; // Icono de pausa
             } else {
                 playingIndicator = '<div class="audio-visualizer"><span></span><span></span><span></span><span></span></div>'; // Visualizador animado
             }
        }
        // ⬆️ FIN LÓGICA DEL VISUALIZADOR (MODIFICADO) ⬆️

        htmlContent += `
            <div class="modal-item song-item ${isCurrentlyPlaying ? 'current-song-artist-view' : ''}" data-song-index="${index}" data-artist="${artistName}" data-genre="${genre}">
                <div class="item-number">${songNumber}</div> 
                <div class="item-art song-item-art" style="background-image: url('${song.imgSrc}')"></div>
                <div class="modal-item-info">
                    <span class="item-title">${song.title} ${playingIndicator}</span>
...
function renderPlaylistMainModal() {
    ...
    document.querySelectorAll('.playlist-item').forEach(item => {
        ...
        item.querySelector('.item-art').addEventListener('click', (e) => { // Clic en la carátula (Reproducir)
            e.stopPropagation(); // Evitar que se active el listener del contenedor si es que existe
            const playlistName = item.dataset.playlistName;
            originalPlaylist = userPlaylists[playlistName];
            currentPlaylist = [...originalPlaylist];
            loadSong(0, true); 
...
function updatePlayPauseIcons(isPlaying) {
    ...
    // 💡 IMPORTANTE: Si la vista de artista full screen está abierta y el estado cambia, 
    // debemos re-renderizar para actualizar el visualizador/icono de pausa.
    if (appModal.classList.contains('full-screen-artist-view') && currentGenreContext) {
        const artistName = currentPlaylist[currentSongIndex].artist;
        // Solo re-renderizar si la canción actual es de un artista que se puede renderizar
        const artist = fullMusicData[currentGenreContext].find(a => a.name === artistName);
        if (artist) {
            renderArtistFullView(currentGenreContext, artistName);
        }
    }
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ⬇️ INICIO CAMBIO PRINCIPAL: Descarga Directa ⬇️
    if (sidebarDownloadAppBtn) {
        sidebarDownloadAppBtn.addEventListener('click', () => {
            closeSidebar();
            
            // Crea un elemento 'a' invisible para simular la descarga
            const downloadUrl = "https://www.mediafire.com/file/dce15ivmvv0dkhn/iMusicPro-JuanZamora.apk/file";
            const link = document.createElement('a');
            link.href = downloadUrl;
            link.download = "iMusicPro-JuanZamora.apk"; // Esto fuerza el nombre del archivo
            document.body.appendChild(link);
            link.click();
            document.body.removeChild(link);
            
            // Muestra un aviso de inicio de descarga
            openModal("iMusic Pro", `<p style="color:var(--spotify-green); font-weight:700; text-align:center; padding: 20px;">
                Vas a Descargar: <strong>iMusic Pro, se te dirigira al navegador</strong>. (La descarga iniciará al dar clic en descargar "botón azul").
                </p>`);
            
        });
    }
    // ⬆️ FIN CAMBIO PRINCIPAL: Descarga Directa ⬆️
