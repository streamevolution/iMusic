...
function closeModal() {
    ...
    if (headerFixed) {
        headerFixed.remove();
        // Volver a añadir el header estándar si fue eliminado (Solo lo hacemos si no existe ya)
        ...
        <div class="library-content-wrapper">
            ...
            <div class="library-sections-grid">
                ...
                <div class="library-section-card" id="favoritesCard">
                    <div class="library-card-art" style="background-image: url('https://i.postimg.cc/qR05Y223/favorites-art.png'); background-color: #1DB954;"></div>
...
function renderFavoritesListInLibrary() {
    ...
    // 2. Crear y añadir el header fijo para Favoritos
    let headerFixed = document.querySelector('.library-header-fixed');
    if (!headerFixed) {
        headerFixed = document.createElement('div');
        headerFixed.className = 'library-header-fixed';
    ...
    if (favoritesList.length === 0) {
        ...
        // 3. Contenido de la lista con botón de reproducción aleatoria
        htmlContent = `
            <div class="library-content-wrapper">
    ...
    document.getElementById('favoritesBackBtn').addEventListener('click', () => {
         // Restaurar la cabecera antes de volver
         headerFixed.remove();
         renderLibraryView();
    });

    // La 'X' y el cierre deben volver a la vista de la biblioteca principal
    closeModalBtn.onclick = null;
