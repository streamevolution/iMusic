...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (sidebarDownloadAppBtn) {
        sidebarDownloadAppBtn.addEventListener('click', () => {
            ...
            const downloadUrl = "iMusicPro-JuanZamora.apk";
            ...
            openModal("Descarga Iniciada", `<p style="color:var(--spotify-green); font-weight:700; text-align:center; padding: 20px;">
                Descargando: <strong>iMusicPro-JuanZamora.apk</strong>. (La descarga solo funcionará si el archivo existe en el servidor).
                </p>`);
